...
if (ping_index_<0)  {
        ...
        ping_index_ = (int) ((0.0 -angle_min_)/angle_increment_);//.............1(to determine the index of the ping)
        ROS_INFO("Corridor scan begins");
        
    
   
}
int difference;
int temp_ping_index=ping_index_;
for(difference=-180;difference<=180;difference++){
ping_index_=temp_ping_index;//returns the value of ping_index which was at (1)
ping_index_=ping_index_+difference;
...
ROS_INFO("DANGER, PLEASE CHANGE DIRECTION");
laser_alarm_=true;}

}
ping_index_=-1;//reset ping index
ROS_INFO("Corridor scan complete");
